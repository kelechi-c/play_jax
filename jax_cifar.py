...
train_loader = DataLoader(train_data, batch_size=32, shuffle=True, collate_fn=jax_collate)
...
def loss_func(params: jax.Array, inputs: jax.Array, labels: jax.Array, dropout_key) -> jax.Array:
...
def trainer(
    ...
    wandb_logger(key=None, model=model, project_name='play_jax', run_name='resnet-tune-1')
